...
- (NSString *)weekday
{
    ...
    switch (weekday) {
        case 1:
            week = LocalizedString(@"String_sunday");
            break;
        case 2:
            week = LocalizedString(@"String_monday");
            break;
        case 3:
            week = LocalizedString(@"String_tuesday");
            break;
        case 4:
            week = LocalizedString(@"String_wendsday");
            break;
        case 5:
            week = LocalizedString(@"String_thursday");
            break;
        case 6:
            week = LocalizedString(@"String_friday");
            break;
        case 7:
            week = LocalizedString(@"String_saturday");
            break;
